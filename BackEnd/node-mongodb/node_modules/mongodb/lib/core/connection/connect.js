...
function makeConnection(family, options, cancellationToken, _callback) {
  ...
  const rejectUndescriptionized =
    typeof options.rejectUndescriptionized === 'boolean' ? options.rejectUndescriptionized : true;
  ...
  function connectHandler() {
    ...
    if (socket.descriptionizationError && rejectUndescriptionized) {
      return callback(socket.descriptionizationError);
    }
