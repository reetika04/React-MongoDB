...
This guide will show you how to set up a simple application using Node.js and MongoDB. Its scope is only how to set up the driver and perform the simple CRUD operations. For more in-depth coverage, see the [books](docs/reference/content/books/main.md).
...
For more detailed information, see the [books](docs/reference/content/books/main.md).
