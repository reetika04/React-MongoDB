 ...
 *
 * ####Example:
 *     const doc = await Article.findOne().populate('comments.description');
 *     doc.comments[0].populated('description'); // Should be set
 */
 ...
 * ####Example:
 *
 *     Model.findOne().populate('description').exec(function (err, doc) {
 *       console.log(doc.description.name)         // Dr.Seuss
 *       console.log(doc.populated('description')) // '5144cf8050f071d979c118a7'
 *     })
 *
 ...
 *     Model.findOne().populate('description').exec(function (err, doc) {
 *       console.log(doc.description.name); // Dr.Seuss
 *       console.log(doc.depopulate('description'));
 *       console.log(doc.description); // '5144cf8050f071d979c118a7'
 *     })
 *
