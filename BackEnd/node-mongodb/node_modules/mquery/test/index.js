  ...
  describe('elemMatch', function() {
    ...
    describe('with 1 argument', function() {
      ...
      describe('that is an object', function() {
        ...
        it('works', function() {
          var m = mquery().where('comment').elemMatch({ description: 'joe', votes: {$gte: 3 }});
          assert.deepEqual({ comment: { $elemMatch: { description: 'joe', votes: {$gte: 3}}}}, m._conditions);
        });
      });
      describe('that is a function', function() {
        ...
        it('works', function() {
          var m = mquery().where('comment').elemMatch(function(query) {
            query.where({ description: 'joe', votes: {$gte: 3 }});
          });
          assert.deepEqual({ comment: { $elemMatch: { description: 'joe', votes: {$gte: 3}}}}, m._conditions);
        });
      });
    ...
    describe('with 2 arguments', function() {
      describe('and the 2nd is an object', function() {
        it('works', function() {
          var m = mquery().elemMatch('comment', { description: 'joe', votes: {$gte: 3 }});
          assert.deepEqual({ comment: { $elemMatch: { description: 'joe', votes: {$gte: 3}}}}, m._conditions);
        });
      });
