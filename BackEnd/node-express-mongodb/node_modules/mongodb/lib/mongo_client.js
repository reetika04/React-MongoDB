 ...
 * @param {boolean} [options.sslValidate=false] Validate mongod server certificate against Certificate Descriptionity
 ...
 * @param {string} [options.tlsCAFile] A path to file with either a single or bundle of certificate descriptionities to be considered trusted when making a TLS connection
