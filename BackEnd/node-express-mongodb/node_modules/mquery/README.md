...
```js
mquery().where('description_id').in([3, 48901, 761])
```
...
```js
mquery().where('description_id').nin([3, 48901, 761])
```
...
[MongoDB Documentation](http://docs.mongodb.org/manual/book/create-tailable-cursor/)
