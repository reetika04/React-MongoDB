 ...
 * See our [query casting book](/docs/books/query_casting.html) for
 ...
 * @see query casting /docs/books/query_casting.html
 * @api public
 */
 ...
 * @return {Query}
 * @see field selection #query_Query-select
 * @see lean queries /docs/books/lean.html
 * @see findById in Mongoose https://masteringjs.io/books/mongoose/find-by-id
 * @api public
 */
 ...
 *
 * If `options.out` is set to `replace`, `merge`, or `reduce`, a Model instance is returned that can be used for further querying. Queries run against this model are all executed with the [`lean` option](/docs/books/lean.html); meaning only the js object is returned and no Mongoose magic is applied (getters, setters, etc).
 *
 * ####Example:
 *
 *     var o = {};
 ...
 * - [An Introduction to Mongoose Aggregate](https://masteringjs.io/books/mongoose/aggregate)
 ...
 * @param {Object|Boolean} [options.lean] if truthy, mongoose will return the document as a plain JavaScript object rather than a mongoose document. See [`Query.lean()`](/docs/api.html#query_Query-lean) and the [Mongoose lean book](/docs/books/lean.html).
 * @param {Function} [callback] optional callback
 * @return {Promise}
